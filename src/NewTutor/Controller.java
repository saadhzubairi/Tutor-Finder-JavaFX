    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        Add_Tut_bt.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                Tutor t = new Tutor(pwd, 0, namef.getText(), Integer.parseInt(agec.getValue().toString()), sexc.getValue().toString(), locc.getValue().toString(), emailf.getText(), phonef.getText(), qualc.getValue().toString(), statusc.getValue().toString(), isHome.isFocused(), plocc.getValue().toString(), expf.getText(), classes);
